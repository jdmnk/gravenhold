...
- Drops are derived from seed, run id, level, encounter index, skill, and result.
...
- The end-of-level reward screen should be removed or reserved for rare special
  rewards.
