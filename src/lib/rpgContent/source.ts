// Display-only RPG content keyed by Cairo numeric IDs.
// Rule-bearing content lives in contracts/src/content/data.cairo.

export const displayStoryText = {
  "actIntros": {
    "1": {
...
export const displayEncounterText = {
  "1": {
